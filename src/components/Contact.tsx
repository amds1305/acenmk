      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Prêt à transformer votre gestion d'actifs ?</h2>
              <p className="text-xl text-muted-foreground">
                Contactez-nous pour découvrir comment notre plateforme peut répondre à vos besoins spécifiques.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">contact@acenumerik.fr</p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h3 className="text-lg font-medium">Chat en ligne</h3>
                  <p className="text-muted-foreground">Disponible 24/7 pour vous assister</p>
                </div>
              </div>
            </div>
