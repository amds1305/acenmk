...
const Footer = () => {
  ...
  return (
    <footer className="bg-muted pt-16 pb-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          {/* Logo et info */}
          <div className="lg:col-span-2">
            <a href="/" className="text-2xl font-bold tracking-tight font-display inline-flex mb-4">
          ...
          {/* Liens rapides */}
          <div>
            <h4 className="font-medium text-lg mb-4">Produit</h4>
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-muted-foreground hover:text-foreground transition-colors">Cas d'usage</a></li>
          ...
          {/* Entreprise */}
          <div>
            <h4 className="font-medium text-lg mb-4">Entreprise</h4>
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-muted-foreground hover:text-foreground transition-colors">Partenaires</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-muted-foreground hover:text-foreground transition-colors">Statut système</a></li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex space-x-6">
            ...
            <a href="#" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Conditions d'utilisation</a>
          </div>
        </div>
      </div>
    </footer>
