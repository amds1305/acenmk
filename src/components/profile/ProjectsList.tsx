...
const ProjectsList: React.FC<ProjectsListProps> = ({ projects, getStatusColor, getStatusText, formatDate }) => {
                  ...
                  <Dialog>
                    ...
                    <DialogContent>
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Dernière mise à jour: {formatDate(project.lastUpdated || project.dueDate)}
                        </DialogDescription>
                      </DialogHeader>
                      <div className="py-4">
