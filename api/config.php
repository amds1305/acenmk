...
define('DB_HOST', 'mysql-votre-database.alwaysdata.net');  // Remplacez par votre serveur MySQL réel
define('DB_USER', 'votre_utilisateur');                    // Remplacez par votre nom d'utilisateur réel
define('DB_PASS', 'votre_mot_de_passe');                   // Remplacez par votre mot de passe réel 
define('DB_NAME', 'votre_base_de_donnees');                // Remplacez par le nom de votre base de données réelle
